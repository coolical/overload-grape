...
triggers = [{"name":"discord playlist", "reply": [discordPlaylistEmbed], "description": "displays information related to discord playlist", "typeWait": False, "prob": 100},
 {"name":"morning", "reply": ["Good morning! Anyone up for a morning put?"], "description": "I'll sometimes reply to a morning greeting", "typeWait": True, "prob": 50}]#prob must be [0,100] 
